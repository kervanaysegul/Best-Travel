...
<head>
    ...
    ================================================== -->
    <meta charset="utf-8">
    <title>BestTravel | <?php echo $blogMetaTitle; ?></title>
                ...
                <article class="s-content__entry format-standard">
                    ...
                    <div class="s-content__primary">
                        ...
                        <div class="s-content__entry-meta">
                            <div class="entry-author meta-blk">
                                <div class="author-avatar">
                                    <img class="avatar" src="images/profilee.png" alt="">
                                </div>
                                <div class="byline">
                                    <span class="bytext">Posted By</span>
                                    <a href="#">Best Travel</a>
                                </div>
                            </div>
                        ...
                        <div class="s-content__pagenav">
                            ...
                            $sqlGetPreviousBlog = "SELECT * FROM blog_post WHERE n_blog_post_id = (SELECT max(n_blog_post_id) FROM blog_post 
                            WHERE n_blog_post_id < '".$blogPostId."') AND f_post_status = '1'";
                            $queryGetPreviousBlog = mysqli_query($conn, $sqlGetPreviousBlog);

                            $sqlGetNextBlog = "SELECT * FROM blog_post WHERE n_blog_post_id = (SELECT min(n_blog_post_id) FROM blog_post 
                            WHERE n_blog_post_id > '".$blogPostId."') AND f_post_status = '1'";
                            ...
                            if (mysqli_num_rows($queryGetNextBlog) > 0) {

                                $rowGetNextBlog = mysqli_fetch_assoc($queryGetNextBlog);
                                ...
                                <div class="comment__info">
                                    ...
                                    <div class="comment__meta">
                                        ...
                                        <div class="comment__reply">
                                            <a class="comment-reply-link" href="#reply-comment-section" onclick="prepareReply('<?php echo $commentId; ?>');"></a>
                                        </div>
                                    </div>
                                </div>
            ...
            if (!name || !email || !comment) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "success") {
                            var newComment = "<li class='depth-1 comment'><div class='comment__content'><div class='comment__info'><div class='comment__author'>" + name
                             + "</div><div class='comment__meta'><div class='comment__time'>" + dateFormatted + "</div></div></div><div class='comment__text'><p>" + comment 
                             + "</p></div></div></li>";
